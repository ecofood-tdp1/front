...
export const EditMenuForm = (props: EditMenuProps) => {
  ...
  const inputPicture = () => {
    if (name.toLowerCase().includes("faina")) {
      setPicture("https://media-cdn.tripadvisor.com/media/photo-s/12/0d/5f/75/faina.jpg")
    } else if (name.toLowerCase().includes("ensalada")) {
      setPicture("https://imag.bonviveur.com/ensalada-cesar-casera.jpg")
    } else {
      setPicture("https://resizer.glanacion.com/resizer/v2/pizzeria-RGSBSRZT2ZAO3NFZXXP6M47U4I.JPG?auth=b95c547c8ece98d0cc192af4c903448176235b5a55380b65e9ef97d5b495e4b2&width=768&quality=80&smart=false")
    }
  }
